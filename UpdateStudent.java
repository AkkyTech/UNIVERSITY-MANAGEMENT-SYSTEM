    ...
    public void actionPerformed(ActionEvent e){
        ...
        else if(e.getSource()==b1)
        {
            ...
            try{
                ...
                conn.s.executeUpdate("update studentdetails set s_name='"+s+"', father_name='"+s6+"', age='"+s1+"', address='"+s2+"', email='"+s3+"', dob='"+s7+"', phone='"+s8+"', X_marks='"+s9+"', XII_marks='"+s4+"', branch='"+s12+"', aadhar_no='"+s10+"', course='"+s11+"', roll='"+s5+"'");
